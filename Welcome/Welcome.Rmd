...
4.  If you are starting a PhD or Postdoc position, get yourself added to the predoc or postdoc mailing lists. Contact Nikki Mann (Digital Communications Manager) at [ndo23\@cam.ac.uk](mailto:ndo23@cam.ac.uk){.email}.
...
Gehad Youssef (gy260\@cam.ac.uk) maintains `mti-ai-srv-01` and Holly Giles ([harg2\@cam.ac.uk](mailto:sr952@cam.ac.uk){.email}) currently maintains `mti-ai-srv-02`. Contact them if you need help. If you are taking over as a server maintainer, see also the Server Maintenance document online.
